...
public class TestModel {
	...
	@Test
	public void test() {
		Account acc1 = new Account(1, "USD", 500_000);
		Account acc2 = acc1.addBalance(500_000);
		...
		Order order2 = new Order(3, 1, Optional.of(1L), "EUR/USD", 128000, -1000, OrderStatus.FILLED, OrderType.MARKET);
		acc4 = acc4.applyFill(new Fill(3L, acc4.id, 1L, order2.size, order2.price, order2));
